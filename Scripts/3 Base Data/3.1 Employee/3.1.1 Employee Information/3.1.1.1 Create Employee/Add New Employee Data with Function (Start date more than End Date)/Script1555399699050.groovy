...
WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System Asyst/button_Add New function'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_WorkForce Management System Asyst/select_-- Lists function --CGKAS_MPL_BTT'), 
    'CGKAS_MPL_BTT', true)

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System Asyst/input_Function Name_cek_func_start'))

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System Asyst/input_Start Date_cek_func_end'))

WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System Asyst/input_Start Date_inp_start_func'), 
    '2019-04-16')

WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System Asyst/input_End Date_inp_end_func'), '2019-01-01')

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System Asyst/button_Save_function'))
...
not_run: WebUI.click(findTestObject('Page_WorkForce Management System As/span_Save'))
