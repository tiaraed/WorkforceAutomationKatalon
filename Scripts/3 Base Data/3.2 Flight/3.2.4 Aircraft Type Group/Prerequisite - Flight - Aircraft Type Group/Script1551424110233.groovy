...
WebUI.waitForElementVisible(findTestObject('Page_Asyst Workforce asd/span_Aircraft Type Group'), 60)

WebUI.click(findTestObject('Object Repository/Page_Asyst Workforce asd/span_Aircraft Type Group'))
