...
WebUI.setText(findTestObject('Page_WorkForce Management System As/input_From_inp_over_from'), 'zzzzzzzzzz')

WebUI.setText(findTestObject('Page_WorkForce Management System As/input_Until_inp_over_until'), 'xxxxxxxxxxxxxxxx')

WebUI.click(findTestObject('Page_WorkForce Management System As/button_Save (4)'))

WebUI.verifyTextPresent('Overtime From Time Not a valid time format HH:mm', true)
