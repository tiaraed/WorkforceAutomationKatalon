...
WebUI.setText(findTestObject('Page_WorkForce Management System As/input__inp_qua_name'), 'AAABEBE')

WebUI.click(findTestObject('Page_WorkForce Management System As/button_remove all'))
