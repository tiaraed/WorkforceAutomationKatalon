...
WebUI.click(findTestObject('Page_WorkForce Management System As/i_X31_fa fa-trash'))

WebUI.verifyTextPresent('Are you sure to delete this data ?', true)

WebUI.click(findTestObject('Page_WorkForce Management System As/input_Are you sure to delete t (1)'))
