...
WebUI.click(findTestObject('Page_WorkForce Management System As/Page_WorkForce Management System Aircraft Type Group/i_Y_fa fa-trash'))

WebUI.click(findTestObject('Page_WorkForce Management System As/Page_WorkForce Management System Aircraft Type Group/input_Are you sure to delete t (No)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_WorkForce Management System As/Page_WorkForce Management System Aircraft Type Group/a_FQ'), 
    30)
