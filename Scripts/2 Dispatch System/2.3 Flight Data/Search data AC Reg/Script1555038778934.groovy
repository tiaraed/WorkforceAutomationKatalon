...
WebUI.selectOptionByValue(findTestObject('Page_WorkForce Management System As/select_-- Table Data -- (1)'), 'ac', true)

WebUI.setText(findTestObject('Page_WorkForce Management System As/input_Search Data By_inp_fligh'), 'PK-GCC')

WebUI.click(findTestObject('Page_WorkForce Management System As/span_Search (8)'))

WebUI.verifyTextPresent('GA 735', true)
