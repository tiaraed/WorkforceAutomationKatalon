...
WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System As/input__inp_task_qua'), 'PB_BI_CKI')

WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System As/input__inp_start_date task list'), '2019-02-28')

WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System As/input__inp_task_start_time'), 'hahahahaha')

WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System As/input__inp_task_end_time'), 'heheheheehe')
...
WebUI.verifyTextPresent('Task Start_Time Not a valid time format HH:mm', true)
