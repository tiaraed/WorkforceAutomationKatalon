...
WebUI.setText(findTestObject('Page_WorkForce Management System As/input_Shift Type_inp_shift_sea'), '0100')

WebUI.click(findTestObject('Page_WorkForce Management System As/span_Search (2)'))

WebUI.click(findTestObject('Page_WorkForce Management System As/i_Y_fa fa-trash (1)'))
...
WebUI.verifyElementPresent(findTestObject('Page_WorkForce Management System As/h1_Shift Type'), 50)
