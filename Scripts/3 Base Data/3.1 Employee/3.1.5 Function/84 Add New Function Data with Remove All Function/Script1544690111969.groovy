...
WebUI.setText(findTestObject('Page_WorkForce Management System As/input__inp_func_code'), 'AAG_EDIT_BB')
...
WebUI.click(findTestObject('Page_WorkForce Management System As/button_remove all (1)'))
