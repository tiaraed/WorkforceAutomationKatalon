...
WebUI.setText(findTestObject('Page_WorkForce Management System Asyst/input_Created Date_inp_manage_notif_date'), '2019-03-18')

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System Asyst/button_Search'))

WebUI.verifyTextPresent('HASANUDIN', true)
