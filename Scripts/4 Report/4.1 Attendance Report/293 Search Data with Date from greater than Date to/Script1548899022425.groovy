...
WebUI.setText(findTestObject('Page_WorkForce Management System As/input_Date From_inp_rpt_attend'), '2019-01-31')

WebUI.setText(findTestObject('Page_WorkForce Management System As/input_Date To_inp_rpt_attendan'), '2019-01-01')

WebUI.click(findTestObject('Page_WorkForce Management System As/button_Search (4)'))

WebUI.verifyTextPresent('DateFrom can\'t greater than DateTo', true)
