...
WebUI.setText(findTestObject('Page_WorkForce Management System As/input_Employee_inp_emp_search'), 'abi')

WebUI.click(findTestObject('Page_WorkForce Management System As/span_Search'))

WebUI.verifyTextPresent('ABI MUHAMMAD', true)

WebUI.click(findTestObject('Page_WorkForce Management System As/i_Y_fa fa-edit'))

WebUI.setText(findTestObject('Page_WorkForce Management System As/input_First Name_inp_first_nam'), 'AB')

WebUI.setText(findTestObject('Page_WorkForce Management System As/input__inp_last_name'), 'MUHAMMAD')
