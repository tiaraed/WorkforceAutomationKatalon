...
WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/input_Are you sure to delete t'))

WebUI.verifyTextPresent('Data has been Delete succesfully', true)

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/input_Data has been Delete suc'))
