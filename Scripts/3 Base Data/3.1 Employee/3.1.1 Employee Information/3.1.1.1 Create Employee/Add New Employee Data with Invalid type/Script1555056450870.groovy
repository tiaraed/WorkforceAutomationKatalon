...
WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/span_Base Data'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_WorkForce Management System As/span_Employee'), 50)

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/span_Employee'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_WorkForce Management System As/span_Employee Information'), 
    50)

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/span_Employee Information'))

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/button_Add New'))

WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System As/input__inp_empid'), '*&^%$')
...
WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System As/input_Email_inp_email (1)'), 'tendaebubahehehe')
...
WebUI.verifyTextPresent('please Enter a email valid', true)
