...
WebUI.waitForElementVisible(findTestObject('Page_WorkForce Management System As/span_Employee Information'), 50)
...
WebUI.setText(findTestObject('Object Repository/Page_WorkForce Management System As/input__inp_empid'), '778')
...
WebUI.verifyTextPresent('Employee ID Already Exist', true)
