...
WebUI.setText(findTestObject('Page_WorkForce Management System As/input__inp_publication'), '014')

WebUI.setText(findTestObject('Page_WorkForce Management System As/input__inp_normal_from'), 'abcdefghijklmn')

WebUI.setText(findTestObject('Page_WorkForce Management System As/input__inp_normal_until'), 'qwertyuiop')

WebUI.click(findTestObject('Page_WorkForce Management System As/button_Save (3)'))

WebUI.verifyTextPresent('Normal From Time Not a valid time format HH:mm', true)
