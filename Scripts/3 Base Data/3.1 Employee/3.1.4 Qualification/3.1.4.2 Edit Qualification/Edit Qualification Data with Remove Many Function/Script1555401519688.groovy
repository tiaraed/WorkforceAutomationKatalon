...
WebUI.click(findTestObject('Page_WorkForce Management System As/li_CGKAS_MPL_BTT selected'))

WebUI.click(findTestObject('Page_WorkForce Management System As/button_remove'))

WebUI.click(findTestObject('Page_WorkForce Management System As/li_CGKAS_MPL_LM selected'))

WebUI.click(findTestObject('Page_WorkForce Management System As/button_remove'))

WebUI.click(findTestObject('Page_WorkForce Management System As/span_Save (2)'))
