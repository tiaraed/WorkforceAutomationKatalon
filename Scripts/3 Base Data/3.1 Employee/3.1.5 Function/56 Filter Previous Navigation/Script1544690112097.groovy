...
WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/a_3_2'))

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/a_Page 3 of 3_lnk_shift_prev'))
