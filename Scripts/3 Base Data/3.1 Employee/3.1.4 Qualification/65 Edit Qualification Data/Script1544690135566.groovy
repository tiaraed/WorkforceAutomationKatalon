...
WebUI.click(findTestObject('Page_WorkForce Management System As/li_CGKAS_MPL_BTT'))

WebUI.click(findTestObject('Page_WorkForce Management System As/button_add'))

WebUI.click(findTestObject('Page_WorkForce Management System As/li_CGKAS_MPL_ATT'))
