...
WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/a_2'))

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/a_Page 2 of 20_lnk_qua_prev'))
