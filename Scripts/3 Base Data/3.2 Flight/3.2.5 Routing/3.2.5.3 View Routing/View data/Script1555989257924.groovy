...
WebUI.waitForElementVisible(findTestObject('Page_Asyst Workforce asd/span_Base Data'), 60)
...
WebUI.waitForElementVisible(findTestObject('Page_Asyst Workforce asd/span_Routing'), 60)

WebUI.click(findTestObject('Page_Asyst Workforce asd/span_Routing'))

WebUI.verifyElementPresent(findTestObject('Page_WorkForce Management System As/Page_WorkForce Management System Route/button_Add New'), 
    30)
