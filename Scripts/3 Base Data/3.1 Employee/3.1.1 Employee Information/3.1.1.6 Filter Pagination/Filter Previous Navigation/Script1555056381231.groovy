...
WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/a_4'))

WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/i_Page 4 of 12_fa fa-angle-lef'))
