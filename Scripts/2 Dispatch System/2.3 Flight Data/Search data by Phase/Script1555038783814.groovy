...
WebUI.selectOptionByValue(findTestObject('Page_WorkForce Management System As/select_-- Table Data -- (1)'), 'phase', true)

WebUI.setText(findTestObject('Page_WorkForce Management System As/input_Search Data By_inp_fligh'), 'A')

WebUI.click(findTestObject('Page_WorkForce Management System As/span_Search (8)'))

WebUI.verifyTextPresent('KE 6564', true)
