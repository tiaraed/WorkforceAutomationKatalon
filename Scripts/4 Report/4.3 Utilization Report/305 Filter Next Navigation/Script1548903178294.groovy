...
WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/a_Page 1 of 10_lnk_rpt_utiliza'))

WebUI.verifyTextPresent('\tANGGI TANIA PUTRI', true)

not_run: WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/a_4 (4)'))

not_run: WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/button_Reset (2)'))

not_run: WebUI.click(findTestObject('Object Repository/Page_WorkForce Management System As/a_Page 4 of 10_lnk_rpt_utiliza'))
