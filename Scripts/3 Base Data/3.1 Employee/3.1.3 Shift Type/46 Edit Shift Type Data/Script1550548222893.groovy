...
WebUI.setText(findTestObject('Page_WorkForce Management System As/input_From_inp_over_from'), '02:30')

WebUI.setText(findTestObject('Page_WorkForce Management System As/input_Until_inp_over_until'), '23:30')
